            ...
            <main>
                <div class="container-fluid px-4">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <?= form_open_multipart('account/userlist/edit/' . $id); ?>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-input" type="number" name="role_id" id="role_id" checked>
                                <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                                    <input type="radio" class="btn-check" name="btnradio" id="btnradio1" autocomplete="off" checked>
                                    <label class="btn btn-outline-primary" for="btnradio1">Admin</label>
                                    <input type="radio" class="btn-check" name="btnradio" id="btnradio2" autocomplete="off">
                                    <label class="btn btn-outline-primary" for="btnradio2">Member</label>
                                </div>
                            </div>
                            <div class="form-group mb-3">
